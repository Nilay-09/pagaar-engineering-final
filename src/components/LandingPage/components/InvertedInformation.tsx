...
export default function InvertedInformation() {
  ...
  return (
    <div className='w-screen h-full lg:h-[495px] flex  items-center relative overflow-hidden'>
      <img src={BG_GRID} alt="" className='absolute top-0 -right-[65px] -z-10' />

      <div className="w-full h-full px-6 md:px-[60px] lg:px-[100px] xl:pl-[112px] xl:pr-[78px] xl:py-[72px]">
        <div className="w-full h-full flex justify-center lg:justify-between pt-[44px] md:pt-[60px] xl:pt-0 flex-col lg:flex-row-reverse">
          <div className="py-2 w-full lg:w-[437px] flex flex-col gap-[20px]">
          ...
          <div className="md:mt-[56px] xl:mt-0 lg:w-[662px] w-full h-full mb-4 lg:mx-0">
